...
class TProtonReconstruction  
{
	...
	double t_left_GeV2, t_right_GeV2, t_GeV2, t_y_GeV2, t_left_far_GeV2, t_right_far_GeV2, t_far_GeV2, minus_t_far_GeV2, t_y_far_GeV2, minus_t_y_far_GeV2 ;
	...
	void Reconstruct(ULong64_t event_info_timestamp, UInt_t trigger_data_run_num, UInt_t trigger_data_event_num,
	 double x_l_n_mm, double x_l_f_mm, double x_r_n_mm, double x_r_f_mm, double y_l_n_mm, double y_l_f_mm, double y_r_n_mm, double y_r_f_mm,
							  ...
							  TBeamOptics *BeamOptics_Beam_1, TBeamOptics *BeamOptics_Beam_2, TRPAlignment *, int) ;
...
const double *TProtonReconstruction::GetReconstructedVariable(string variable_name)
{
	...
	else if(variable_name.compare("minus_t_GeV2")==0)
	{
        ...
        else if(variable_name.compare("minus_t_far_GeV2")==0)
        {
                return &minus_t_far_GeV2 ;
        }
	...
	else if(variable_name.compare("theta_y_star_far_rad")==0)
	{
		return &theta_y_star_far_rad ;
	}
	...
	TBeamOptics *BeamOptics_Beam_1, TBeamOptics *BeamOptics_Beam_2, TRPAlignment *RPAlignment,  int number_of_RPs)
{
	...
	t_right_GeV2 = ReconstructFourMomentumTransferSquaredGeV2(theta_x_star_right_rad, theta_y_star_right_rad, BeamOptics_Beam_1) ; 
        ...
        t_far_GeV2  = ReconstructFourMomentumTransferSquaredGeV2(theta_x_star_far_rad, theta_y_star_far_rad, BeamOptics_Beam_2) ;
        t_y_far_GeV2 = ReconstructFourMomentumTransferSquaredGeV2(0, theta_y_star_far_rad, BeamOptics_Beam_1) ;
	...
	minus_t_far_GeV2 = -t_far_GeV2 ;
	minus_t_y_far_GeV2 = -t_y_far_GeV2 ;
