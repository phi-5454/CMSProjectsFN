  ...
  (const Measurement & m, double * val)
{
  ...
  { // normal
    ...
    // cout << "detidtest1:  notsaturated " << m.mydetId << " " << endl ;
  ...
  { // saturated
    stringstream ss ;
	 ss << m.mydetId ;
    cout << "detidtest2:  saturated " << m.mydetId << " " << ss.str().substr(0,2) << endl ;
  ...
  (const Measurement & m, double epsilon, double * val)
{
  ...
  if(! m.isSaturated)
  { // normal
    // cout << "detidtest3:  notsaturated " << m.mydetId << " " << endl ;
  ...
  { // saturated
    stringstream ss ;
	 ss << m.mydetId ;
    cout << "detidtest4:  saturated " << m.mydetId << " " << ss.str().substr(0,2) << endl ;
